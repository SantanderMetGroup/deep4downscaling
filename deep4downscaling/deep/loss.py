...
class PerceptualLoss(nn.Module):
    def __init__(self, ignore_nans: bool, device: str, perceptual_loss_type: str, layer_weights: dict,
                 reshape_dim: int, perceptual_term_weight: float = 1.0, mse_term_weight: float = 1.0):
        super().__init__()
        self.ignore_nans = ignore_nans 
        self.device = device
